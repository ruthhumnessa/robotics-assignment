...
message(STATUS "my_pkg: 2 messages, 0 services")

set(MSG_I_FLAGS "-Imy_pkg:/home/tnsu/q1/src/my_pkg/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/tnsu/q1/src/my_pkg/msg/op.msg" NAME_WE)
add_custom_target(_my_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_pkg" "/home/tnsu/q1/src/my_pkg/msg/op.msg" ""
)

get_filename_component(_filename "/home/tnsu/q1/src/my_pkg/msg/pos.msg" NAME_WE)
add_custom_target(_my_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_pkg" "/home/tnsu/q1/src/my_pkg/msg/pos.msg" ""
)
