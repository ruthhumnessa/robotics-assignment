...
(cl:defmethod cl:initialize-instance :after ((m <op>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'op)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_pkg-msg:<op> is deprecated: use my_pkg-msg:op instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <op>))
...
(cl:defmethod z-val ((m <op>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pkg-msg:z-val is deprecated.  Use my_pkg-msg:z instead.")
  (z m))
